...
#SBATCH --output=./output/ninapro_feature_last.txt  # This is where your output and errors are logged
...
spark-submit --executor-memory 10g --driver-memory 10g ./ninapro_RSM_last.py
