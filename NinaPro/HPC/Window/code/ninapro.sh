...
#SBATCH --output=./output/ninapro_winodw_last.txt  # This is where your output and errors are logged
...
spark-submit --executor-memory 10g --driver-memory 10g ./ninapro_window_last.py
